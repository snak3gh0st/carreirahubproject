...
export const B1_QUESTIONS: BankQuestion[] = [
  ...
  // --- Grammar: Reported Speech ---
  {
    ...
    section: 3,
    skillType: 'grammar',
    question: '"She said she _____ looking for a new position."',
  ...
  },
  {
    ...
    skillType: 'reading',
    passage:
      'Before his first interview at a US company, Carlos spent two weeks preparing. He researched the company online, practiced answering common questions in front of a mirror, and prepared a list of questions to ask the interviewer. His Brazilian friends told him that in the US, it is important to maintain eye contact and give a firm handshake. On the day of the interview, Carlos arrived 15 minutes early and felt confident.',
    question: 'What did Carlos do to prepare for his interview?',
    options: [
      'He called the company to ask about the salary',
      'He researched the company, practiced answers, and prepared questions',
      'He asked his manager to write a reference letter',
      'He only practiced his English pronunciation',
    ],
    correctIndex: 1,
  },
  {
    ...
    passage:
      'Before his first interview at a US company, Carlos spent two weeks preparing. He researched the company online, practiced answering common questions in front of a mirror, and prepared a list of questions to ask the interviewer. His Brazilian friends told him that in the US, it is important to maintain eye contact and give a firm handshake. On the day of the interview, Carlos arrived 15 minutes early and felt confident.',
    question: "According to Carlos's friends, what is important in a US interview?",
    options: [
      'Bringing a gift for the interviewer',
      'Wearing formal Brazilian business attire',
      'Maintaining eye contact and giving a firm handshake',
      'Speaking Portuguese if English is difficult',
    ],
    correctIndex: 2,
  },
  {
