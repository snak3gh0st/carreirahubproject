...
const translations = {
  en: {
    ...
    "testResult.reviewWrongAnswers": "Review incorrect answers",
    "testResult.reviewDescription": "See the items you missed, your answer, and the correct answer.",
    "testResult.questionLabel": "Question",
    "testResult.readingPassage": "Reading passage",
    "testResult.yourAnswer": "Your answer",
    "testResult.correctAnswer": "Correct answer",
    "testResult.notAnswered": "Not answered",
    "testResult.explanation": "Explanation",
    "testResult.allCorrectTitle": "Excellent work",
    "testResult.allCorrectDescription": "You answered every question correctly in this test.",
  ...
  "pt-BR": {
    ...
    "testResult.reviewWrongAnswers": "Revisão das erradas",
    "testResult.reviewDescription": "Veja as questões que você errou, a sua resposta e o gabarito.",
    "testResult.questionLabel": "Questão",
    "testResult.readingPassage": "Texto de apoio",
    "testResult.yourAnswer": "Sua resposta",
    "testResult.correctAnswer": "Resposta correta",
    "testResult.notAnswered": "Não respondida",
    "testResult.explanation": "Explicação",
    "testResult.allCorrectTitle": "Excelente trabalho",
    "testResult.allCorrectDescription": "Você acertou todas as questões deste teste.",
