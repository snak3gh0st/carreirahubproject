  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="flex justify-between items-center mb-6 print:hidden">
        <a href="/hub/documents" className="text-sm text-gray-500 hover:underline">← Back to Documents</a>
        <PrintButton />
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 print:shadow-none print:border-none print:p-0">
        ...
        <div className="flex justify-between items-start mb-8 pb-6 border-b border-gray-100">
          <div>
            ...
            <p className="text-sm text-gray-400 mt-1">Payment Receipt</p>
          </div>
        ...
        <div className="grid grid-cols-2 gap-8 mb-8">
          ...
          <div className="text-right">
            <p className="text-xs text-gray-400 uppercase tracking-wide font-medium mb-2">Invoice Details</p>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200">
                <th className="text-left py-3 text-xs text-gray-400 uppercase tracking-wide font-medium">Description</th>
                <th className="text-right py-3 text-xs text-gray-400 uppercase tracking-wide font-medium">Amount</th>
              </tr>
            </thead>
            <tbody>
              {invoice.lineItems && Array.isArray(invoice.lineItems) ? (
                (invoice.lineItems as any[]).map((item: any, i: number) => (
                  <tr key={i} className="border-b border-gray-50">
                    <td className="py-3 text-gray-700">{item.description || "Service"}</td>
                ...
                <tr className="border-b border-gray-50">
                  <td className="py-3 text-gray-700">Service</td>
                  <td className="py-3 text-right text-gray-900 font-medium">
        ...
        <div className="mt-10 pt-6 border-t border-gray-100 text-center">
          <p className="text-xs text-gray-400">
            Carreira U.S.A. · Payment processed by QuickBooks Payments
          </p>
