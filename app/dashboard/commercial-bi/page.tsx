        ...
        <div className="mb-6 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="flex flex-col items-stretch gap-3 lg:items-end">
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 rounded-lg bg-brand-tangerina px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-brand-tangerina/90"
            >
