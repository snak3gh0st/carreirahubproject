...
const navigationSections: NavSection[] = [
  ...
  {
    title: "Vendas & Leads",
    roles: ["ADMIN", "OPERATIONAL", "SALES", "SDR"],
    items: [
      {
        href: "/dashboard/leads",
        label: "Leads",
        icon: Users,
        roles: ["ADMIN", "OPERATIONAL", "SDR", "SALES"],
      },
      {
        href: "/dashboard/conversations",
        label: "Conversas",
        icon: MessageSquare,
        roles: ["ADMIN", "OPERATIONAL", "SUPPORT", "SDR"],
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: "Criar Contrato",
        icon: FilePlus,
        roles: ["ADMIN", "OPERATIONAL", "FINANCE", "SALES"],
      },
      {
        href: "/dashboard/invoices/new",
        label: "Criar Fatura",
      ...
      },
      {
        ...
        label: "Clientes",
        icon: Building2,
        roles: ["ADMIN", "OPERATIONAL", "SALES", "SDR", "FINANCE", "SUPPORT"],
      },
      {
