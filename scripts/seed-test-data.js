 ...
 * - Leads com diferentes statuses
 * - Customers
 * - Deals vinculados a customers e leads
 * - Invoices vinculados a deals
...
// Dados de exemplo
const testUsers = [
  { email: "admin@carreirausa.com", name: "Admin User", role: "ADMIN" },
  { email: "sdr@carreirausa.com", name: "SDR User", role: "SDR" },
  { email: "sales@carreirausa.com", name: "Sales User", role: "SALES" },
  { email: "finance@carreirausa.com", name: "Finance User", role: "FINANCE" },
  { email: "support@carreirausa.com", name: "Support User", role: "SUPPORT" },
];
...
async function seed() {
  ...
  try {
    ...
    // await prisma.user.deleteMany({ where: { email: { not: "admin@carreirausa.com" } } });
