...
const routeRoleMap: { prefix: string; roles: UserRole[] }[] = [
  ...
  { prefix: "/dashboard/leads", roles: ["ADMIN", "COMMERCIAL"] },
  { prefix: "/dashboard/conversations", roles: ["ADMIN", "COMMERCIAL"] },
  { prefix: "/dashboard/invoices", roles: ["ADMIN", "FINANCE", "COMMERCIAL"] },
  { prefix: "/dashboard/payments", roles: ["ADMIN", "FINANCE"] },
  { prefix: "/dashboard/contracts", roles: ["ADMIN", "FINANCE", "COMMERCIAL"] },
  { prefix: "/dashboard/insights", roles: ["ADMIN", "FINANCE"] },
  ...
  { prefix: "/dashboard/customers", roles: ["ADMIN", "FINANCE", "COMMERCIAL"] },
  { prefix: "/dashboard/deals", roles: ["ADMIN", "FINANCE", "COMMERCIAL"] },
  { prefix: "/dashboard/analytics", roles: ["ADMIN", "FINANCE"] },
  { prefix: "/dashboard/financial", roles: ["ADMIN", "FINANCE", "COMMERCIAL"] },
];
